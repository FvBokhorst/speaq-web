...
const appStrings: Record<string, Record<string, string>> = {
  ...
  // Mining
  "mining.title": { en: "Network Mining", ru: "Setevoj majning", nl: "Netwerk Mining", fr: "Minage Reseau", es: "Mineria de Red", de: "Netzwerk Mining", sl: "Omrezno rudarjenje", lg: "Okusimba ku network", sw: "Uchimbaji wa mtandao" },
  "mining.start": { en: "Start Mining", ru: "Nachat majning", nl: "Start Mining", fr: "Demarrer", es: "Iniciar", de: "Starten", sl: "Zacni rudariti", lg: "Tandika okusimba", sw: "Anza uchimbaji" },
  "mining.stop": { en: "Stop Mining", ru: "Ostanovit majning", nl: "Stop Mining", fr: "Arreter", es: "Detener", de: "Stoppen", sl: "Ustavi rudarjenje", lg: "Yimiriza okusimba", sw: "Simamisha uchimbaji" },
