...
const appStrings: Record<string, Record<string, string>> = {
  ...
  "addContact.id": { en: "SPEAQ ID", ru: "SPEAQ ID", nl: "SPEAQ ID", fr: "SPEAQ ID", es: "SPEAQ ID", de: "SPEAQ ID", sl: "SPEAQ ID", lg: "SPEAQ ID", sw: "SPEAQ ID" },
  ...
  // Wallet
  "wallet.balance": { en: "Balance", ru: "Balans", nl: "Saldo", fr: "Solde", es: "Saldo", de: "Guthaben", sl: "Stanje", lg: "Ensawo", sw: "Salio" },
  "wallet.send": { en: "Send", ru: "Otpravit", nl: "Verstuur", fr: "Envoyer", es: "Enviar", de: "Senden", sl: "Poslji", lg: "Wereza", sw: "Tuma" },
  "wallet.receive": { en: "Receive", ru: "Poluchit", nl: "Ontvangen", fr: "Recevoir", es: "Recibir", de: "Empfangen", sl: "Prejmi", lg: "Funa", sw: "Pokea" },
  ...
  "groups.name": { en: "Group Name", ru: "Nazvanie gruppy", nl: "Groepsnaam", fr: "Nom du Groupe", es: "Nombre del Grupo", de: "Gruppenname", sl: "Ime skupine", lg: "Erinnya ly'ekibinja", sw: "Jina la kikundi" },
  "groups.members": { en: "Members", ru: "Uchastniki", nl: "Leden", fr: "Membres", es: "Miembros", de: "Mitglieder", sl: "Clani", lg: "Abavubuka", sw: "Wanachama" },
  // Advanced
  "adv.title": { en: "Advanced", ru: "Dopolnitelno", nl: "Geavanceerd", fr: "Avance", es: "Avanzado", de: "Erweitert", sl: "Napredno", lg: "Ebyenjawulo", sw: "Kiwango cha juu" },
  "adv.ghost": { en: "Private Groups", ru: "Chastnye gruppy", nl: "Prive Groepen", fr: "Groupes Prives", es: "Grupos Privados", de: "Private Gruppen", sl: "Zasebne skupine", lg: "Ebibinja eby'Obwekusifu", sw: "Vikundi vya Kibinafsi" },
  "adv.ghostDesc": { en: "Private group chats for your community", ru: "Chastnye gruppovye chaty dlya vashego soobshchestva", nl: "Prive groepsgesprekken voor je gemeenschap", fr: "Discussions de groupe privees pour votre communaute", es: "Chats grupales privados para tu comunidad", de: "Private Gruppenchats fur Ihre Gemeinschaft", sl: "Zasebni skupinski klepeti za vaso skupnost", lg: "Emboozi z'ekibinja eby'obwekusifu mu kitundu kyo", sw: "Mazungumzo ya vikundi vya faragha kwa jamii yako" },
  "adv.witness": { en: "Witness Mode", ru: "Rezhim svidetelya", nl: "Getuige Modus", fr: "Mode Temoin", es: "Modo Testigo", de: "Zeugenmodus", sl: "Nacin price", lg: "Enkola y'omujulizi", sw: "Hali ya Shahidi" },
  "adv.witnessDesc": { en: "Create tamper-proof evidence records", ru: "Sozdanie zashchishchennykh ot poddelki dokazatelstv", nl: "Maak manipulatiebestendige bewijsrecords", fr: "Creer des enregistrements de preuves inviolables", es: "Crear registros de evidencia a prueba de manipulacion", de: "Manipulationssichere Beweisaufzeichnungen erstellen", sl: "Ustvari dokazne zapise odporne na posege", lg: "Tonda ebiwandiiko by'obujulizi ebitakyusibwa", sw: "Unda rekodi za ushahidi zisizobadilishwa" },
  "adv.deadman": { en: "Safety Check-in", ru: "Mertvaya ruka", nl: "Safety Check-in", fr: "Commutateur d'Homme Mort", es: "Interruptor de Hombre Muerto", de: "Totmannschalter", sl: "Mrtva roka", lg: "Eswiichi y'omufu", sw: "Swichi ya Mtu Aliyekufa" },
  "adv.deadmanDesc": { en: "Auto-alert if you don't check in", ru: "Avto-opoveshchenie esli vy ne otmetites", nl: "Auto-alarm als je niet incheckt", fr: "Alerte automatique si vous ne vous connectez pas", es: "Alerta automatica si no se registra", de: "Auto-Alarm wenn Sie sich nicht melden", sl: "Samodejno opozorilo ce se ne prijavite", lg: "Okulabula kw'otomattiki bwe otoyingira", sw: "Tahadhari otomatiki usipoingia" },
  // Call
  ...
  "info.modules": { en: "10 Modules", ru: "10 Modulej", nl: "10 Modules", fr: "10 Modules", es: "10 Modulos", de: "10 Module", sl: "10 Modulov", lg: "Moduli 10", sw: "Moduli 10" },
  // More menu
  "more.groups": { en: "Groups", ru: "Gruppy", nl: "Groepen", fr: "Groupes", es: "Grupos", de: "Gruppen", sl: "Skupine", lg: "Ebibinja", sw: "Vikundi" },
  "more.call": { en: "Voice Call", ru: "Golosovoj vyzov", nl: "Spraakoproep", fr: "Appel", es: "Llamada", de: "Anruf", sl: "Klic", lg: "Okuyita", sw: "Piga simu" },
  "more.advanced": { en: "Advanced", ru: "Dopolnitelno", nl: "Geavanceerd", fr: "Avance", es: "Avanzado", de: "Erweitert", sl: "Napredno", lg: "Ebyenjawulo", sw: "Kiwango cha juu" },
  "more.lightning": { en: "Lightning", ru: "Lightning", nl: "Lightning", fr: "Lightning", es: "Lightning", de: "Lightning", sl: "Lightning", lg: "Lightning", sw: "Lightning" },
  "more.info": { en: "About", ru: "O prilozhenii", nl: "Over", fr: "A propos", es: "Acerca de", de: "Uber", sl: "O aplikaciji", lg: "Ebikwata ku", sw: "Kuhusu" },
  "more.sovereignId": { en: "Sovereign ID", ru: "Suverennij ID", nl: "Sovereign ID", fr: "Identite Souveraine", es: "ID Soberana", de: "Souverane ID", sl: "Suvereni ID", lg: "ID Eyeefuga", sw: "Kitambulisho Huru" },
  "more.settings": { en: "Settings", ru: "Nastrojki", nl: "Instellingen", fr: "Parametres", es: "Ajustes", de: "Einstellungen", sl: "Nastavitve", lg: "Entegeka", sw: "Mipangilio" },
  "more.transactions": { en: "Transactions", ru: "Tranzaktsii", nl: "Transacties", fr: "Transactions", es: "Transacciones", de: "Transaktionen", sl: "Transakcije", lg: "Entambuza", sw: "Shughuli" },
  ...
  "onb.slide2.sub": { en: "Text, voice, and video calls. Sign up with just a name - no phone number, no email. Calls connect directly between phones whenever possible. When they cannot, they travel through SPEAQ in sealed form. We never see or hear them.", nl: "Tekst, spraak, en videogesprekken. Meld je aan met alleen een naam - geen telefoonnummer, geen email. Gesprekken verbinden waar mogelijk direct tussen telefoons. Als dat niet kan, reizen ze in verzegelde vorm door SPEAQ. Wij zien of horen ze nooit.", fr: "Texte, voix et appels video. Inscrivez-vous avec juste un nom - sans telephone, sans email. Les appels se connectent directement entre telephones quand possible. Sinon, ils passent par SPEAQ sous forme scellee. Nous ne les voyons ni ne les entendons jamais.", es: "Texto, voz y videollamadas. Registrate con solo un nombre - sin telefono, sin email. Las llamadas se conectan directamente entre telefonos cuando es posible. Si no, viajan por SPEAQ en forma sellada. Nunca las vemos ni oimos.", ru: "Tekst, golos i video zvonki. Registratsiya tolko po imeni - bez telefona, bez email. Zvonki podklyuchayutsya napryamuyu mezhdu telefonami kogda eto vozmozhno. Inache oni prokhodyat cherez SPEAQ v zapechatannoj forme. My nikogda ikh ne vidim i ne slyshim.", de: "Text, Sprache und Videoanrufe. Anmeldung mit nur einem Namen - keine Telefonnummer, keine Email. Anrufe verbinden sich nach Moglichkeit direkt zwischen Telefonen. Sonst laufen sie versiegelt durch SPEAQ. Wir sehen oder horen sie nie.", sl: "Besedilo, glas in video klici. Prijavite se samo z imenom - brez telefona, brez emaila. Klici se povezejo neposredno med telefoni, ko je to mogoce. Sicer potujejo skozi SPEAQ v zapecateni obliki. Nikoli jih ne vidimo ali slisimo.", lg: "Bubaka, eddoboozi, ne video. Wewandiise n'erinnya lyokka - tewaliwo namba ya simu, tewaliwo email. Essimu zikwatagana butereevu wakati wa essimu bwe kisoboka. Bwe kitasoboka, ziyita mu SPEAQ nga zigalwa. Tetubirabe wadde okubiwulira.", sw: "Maandishi, sauti, na simu za video. Jisajili kwa jina tu - hakuna nambari ya simu, hakuna barua pepe. Simu huunganishwa moja kwa moja kati ya simu inapowezekana. Kama haziwezi, husafiri kupitia SPEAQ kwa fomu iliyofungwa. Hatuzioni wala kuzisikia." },
  "onb.slide3.title": { en: "Send Q-Credits", nl: "Verstuur Q-Credits", fr: "Envoyer Q-Credits", es: "Enviar Q-Credits", ru: "Otpravit Q-Credits", de: "Q-Credits senden", sl: "Poslji Q-Credits", lg: "Wereza Q-Credits", sw: "Tuma Q-Credits" },
  "onb.slide3.sub": { en: "Send Q-Credits to anyone on SPEAQ - the value of voice, time, and contribution. Today these run on our trusted ledger. Soon they live on a public blockchain that no one party owns.", nl: "Stuur Q-Credits naar iedereen op SPEAQ - de waarde van stem, tijd, en bijdrage. Vandaag draaien ze op ons vertrouwde grootboek. Binnenkort leven ze op een publieke blockchain die geen enkele partij bezit.", fr: "Envoyez des Q-Credits a quiconque sur SPEAQ - la valeur de la voix, du temps et de la contribution. Aujourd'hui ils fonctionnent sur notre registre de confiance. Bientot ils vivront sur une blockchain publique qu'aucune partie ne possede.", es: "Envia Q-Credits a cualquiera en SPEAQ - el valor de la voz, el tiempo y la contribucion. Hoy funcionan en nuestro registro de confianza. Pronto viviran en una blockchain publica que ninguna parte posee.", ru: "Otpravlyajte Q-Credits lyubomu v SPEAQ - tsennost golosa, vremeni i vklada. Segodnya oni rabotayut na nashej dovernoj knige. Skoro oni zhivut na publichnoj blokchejne, kotorym ne vladeet ni odna storona.", de: "Senden Sie Q-Credits an jeden auf SPEAQ - der Wert von Stimme, Zeit und Beitrag. Heute laufen sie auf unserem vertrauenswurdigen Hauptbuch. Bald leben sie auf einer offentlichen Blockchain, die niemandem allein gehort.", sl: "Posljite Q-Credits komurkoli na SPEAQ - vrednost glasu, casa in prispevka. Danes tecejo na nasi zaupanja vredni knjigi. Kmalu zivijo na javnem blockchainu, ki ni v lasti nobene strani.", lg: "Wereza Q-Credits eri buli muntu ku SPEAQ - omuwendo gw'eddoboozi, ekiseera, n'okuyamba. Leero zikola ku kalulu kaffe akeesigwa. Mu kiseera, zinaaba ku blockchain ey'olukale ng'ataliiwo agirimu.", sw: "Tuma Q-Credits kwa yeyote kwenye SPEAQ - thamani ya sauti, muda na mchango. Leo hufanya kazi kwenye daftari letu la kuaminika. Hivi karibuni zitaishi kwenye blockchain ya umma isiyomilikiwa na upande mmoja." },
  "onb.slide4.title": { en: "Storage & Records", nl: "Opslag & Documenten", fr: "Stockage & Archives", es: "Almacenamiento y Registros", ru: "Khranenie i zapisi", de: "Speicher & Aufzeichnungen", sl: "Shramba & Zapisi", lg: "Etterekero & Ennkalo", sw: "Hifadhi na rekodi" },
  "onb.slide4.sub": { en: "Your notes, photos, and proofs - all kept locked on your device. Only you hold the key. SPEAQ never sees what you save.", nl: "Je notities, foto's en bewijzen - allemaal vergrendeld op je toestel bewaard. Alleen jij hebt de sleutel. SPEAQ ziet nooit wat je bewaart.", fr: "Vos notes, photos et preuves - tout reste verrouille sur votre appareil. Vous seul detenez la cle. SPEAQ ne voit jamais ce que vous gardez.", es: "Tus notas, fotos y pruebas - todo guardado bajo llave en tu dispositivo. Solo tu tienes la llave. SPEAQ nunca ve lo que guardas.", ru: "Vashi zapiski, foto i dokazatelstva - vse khranitsya zaperto na vashem ustrojstve. Tolko u vas est klyuch. SPEAQ nikogda ne vidit chto vy sokhranyaete.", de: "Ihre Notizen, Fotos und Belege - alles bleibt verschlusselt auf Ihrem Gerat. Nur Sie haben den Schlussel. SPEAQ sieht nie was Sie speichern.", sl: "Vase zapiske, fotografije in dokazi - vse ostane zaklenjeno na vasi napravi. Samo vi imate kljuc. SPEAQ nikoli ne vidi kar shranite.", lg: "Endagaano zo, ebifaananyi n'obukakafu - byonna bisigala nga bigalwa ku kyuma kyo. Ggwe wekka olina ekisumuluzo. SPEAQ tabeera kiraba ky'otereka.", sw: "Maelezo yako, picha na ushahidi - vyote vimefungwa kwenye kifaa chako. Wewe peke yako una ufunguo. SPEAQ haoni kamwe unachohifadhi." },
  "onb.slide5.title": { en: "Earn by Contributing", nl: "Verdien door bijdragen", fr: "Gagnez en contribuant", es: "Gana contribuyendo", ru: "Zarabotok za vklad", de: "Verdienen durch Beitrag", sl: "Zasluzek s prispevkom", lg: "Funa nga oyamba", sw: "Pata kwa kuchangia" },
  "onb.slide5.sub": { en: "The more you take part - relaying messages, helping others connect - the more Q-Credits you earn. Your contribution becomes value.", nl: "Hoe meer je meedoet - berichten doorgeven, anderen helpen verbinden - hoe meer Q-Credits je verdient. Jouw bijdrage wordt waarde.", fr: "Plus vous participez - en relayant des messages, en aidant les autres a se connecter - plus vous gagnez de Q-Credits. Votre contribution devient valeur.", es: "Cuanto mas participas - retransmitiendo mensajes, ayudando a otros a conectarse - mas Q-Credits ganas. Tu contribucion se convierte en valor.", ru: "Chem bolshe vy uchastvuete - peredavaya soobshcheniya, pomogaya drugim soedinyatsya - tem bolshe Q-Credits vy zarabatyvaete. Vash vklad stanovitsya tsennostyu.", de: "Je mehr Sie teilnehmen - Nachrichten weiterleiten, anderen beim Verbinden helfen - desto mehr Q-Credits verdienen Sie. Ihr Beitrag wird zu Wert.", sl: "Vec ko sodelujete - posredujete sporocila, pomagate drugim se povezati - vec Q-Credits zasluzite. Vas prispevek postane vrednost.", lg: "Singa weenyigira - okutwala obubaka, okuyamba abalala okukwatagana - osinga okufuna Q-Credits. Okuyamba kwo kufuuka omuwendo.", sw: "Kadiri unavyoshiriki zaidi - kupitisha ujumbe, kusaidia wengine kuunganishwa - ndivyo unavyopata Q-Credits zaidi. Mchango wako unakuwa thamani." },
  // Earning detail
  ...
  "ui.ghostWitness": { en: "Storage / Groups / Records / Safety", nl: "Opslag / Groepen / Vastlegging / Veiligheid", fr: "Stockage / Groupes / Enregistrements / Securite", es: "Almacenamiento / Grupos / Registros / Seguridad", ru: "Khranilishche / Gruppy / Zapisi / Bezopasnost", de: "Speicher / Gruppen / Aufzeichnungen / Sicherheit", sl: "Shramba / Skupine / Zapisi / Varnost", lg: "Okutereka / Ebibinja / Okutereka / Obukuumi", sw: "Hifadhi / Vikundi / Rekodi / Usalama" },
  ...
  "welcome.tagline": { en: "Secure communication for everyone", nl: "Veilige communicatie voor iedereen", fr: "Communication securisee pour tous", es: "Comunicacion segura para todos", ru: "Bezopasnaya svyaz dlya vsekh", de: "Sichere Kommunikation fur alle", sl: "Varna komunikacija za vse", lg: "Okwogerako okukuumiddwa buli muntu", sw: "Mawasiliano salama kwa kila mtu" },
  ...
  "wallet.earned": { en: "Earned", nl: "Verdiend", fr: "Gagne", es: "Ganado", ru: "Zarabotano", de: "Verdient", sl: "Zasluzeno", lg: "Ebifuniddwa", sw: "Iliyopatikana" },
  ...
  "earning.totalMined": { en: "Node Wallet Balance", nl: "Node Wallet Saldo", fr: "Solde Portefeuille Noeud", es: "Saldo Cartera Nodo", ru: "Balans koshelka uzla", de: "Node-Wallet-Saldo", sl: "Stanje denarnice vozlisca", lg: "Ssente mu wallet ya node", sw: "Salio la mkoba wa nodi" },
  "earning.totalMinedNote": { en: "Current balance of the public node wallet. Not the total network distribution. A true network-wide total requires aggregating all coinbase outputs and is on the open work list.", nl: "Huidig saldo van de publieke node-wallet. Niet het totale netwerk-uitgegeven bedrag. Een echt netwerk-totaal vereist het optellen van alle coinbase-uitbetalingen en staat op de open werklijst.", fr: "Solde actuel du portefeuille du noeud public. Pas le total distribue par le reseau. Un total reseau reel necessite l'agregation de toutes les sorties coinbase et figure sur la liste des travaux a faire.", es: "Saldo actual de la cartera del nodo publico. No es el total distribuido por la red. Un total real de la red requiere agregar todas las salidas coinbase y esta en la lista de tareas pendientes.", ru: "Tekushchij balans publichnogo koshelka uzla. Ne obshchee raspredelenie seti. Nastoyashchij obshchij itog seti trebuet agregatsii vsekh vyhodov koinbase i nahoditsya v spiske otkrytyh rabot.", de: "Aktueller Saldo der oeffentlichen Node-Wallet. Nicht die gesamte Netzwerk-Verteilung. Ein echter Netzwerk-Gesamtwert erfordert die Aggregation aller Coinbase-Ausgaben und steht auf der offenen Arbeitsliste.", sl: "Trenutno stanje javne denarnice vozlisca. Ne skupna razdelitev omrezja. Pravi skupni znesek omrezja zahteva agregacijo vseh izhodov coinbase in je na seznamu odprtih del.", lg: "Ssente eziri kati mu wallet ya node ey'olukale. Si bonna ebigabiddwa mu mukutu. Omuwendo gw'omukutu ogw'amazima gwetaaga okugatta ebivudde mu coinbase byonna era kiri ku lukalala lw'emirimu egitannamala.", sw: "Salio la sasa la mkoba wa nodi ya umma. Sio jumla ya usambazaji wa mtandao. Jumla halisi ya mtandao inahitaji kujumlisha matokeo yote ya coinbase na iko kwenye orodha ya kazi inayoendelea." },
  ...
  "adv.vault": { en: "Private Storage", nl: "Prive Opslag", fr: "Stockage Prive", es: "Almacenamiento Privado", ru: "Lichnoe khranilishche", de: "Privater Speicher", sl: "Zasebna shramba", lg: "Okutereka kw'Obwekusifu", sw: "Hifadhi ya Kibinafsi" },
  ...
  "info.tagline": { en: "Communication & Value Network", nl: "Communicatie- & Waardenetwerk", fr: "Reseau de Communication & Valeur", es: "Red de Comunicacion & Valor", ru: "Set svyazi i tsennostej", de: "Kommunikations- & Wertenetzwerk", sl: "Komunikacijsko in vrednostno omrezje", lg: "Emikutu gy'Okwogerako n'Omuwendo", sw: "Mtandao wa Mawasiliano na Thamani" },
  ...
  "info.securityDesc": { en: "AES-256-GCM end-to-end message encryption via the browser's Web Crypto API. The relay sees only opaque ciphertext, never the content. Voice and video media use WebRTC DTLS-SRTP. Key exchange uses ML-KEM-768 (FIPS 203, NIST post-quantum). Call signaling (SDP/ICE) is encrypted with an AES-256-GCM session key derived from ML-KEM-768 - the relay cannot read it. Wallet transactions and chain blocks are signed with ML-DSA-65 (FIPS 204) and SPHINCS+ (FIPS 205).", nl: "AES-256-GCM end-to-end versleuteling via de Web Crypto API van de browser. De relay ziet alleen ondoorzichtige ciphertext, nooit de inhoud. Voice en video gebruiken WebRTC DTLS-SRTP. Sleuteluitwisseling gebruikt ML-KEM-768 (FIPS 203, NIST post-quantum). Voice/video signaling (SDP/ICE) is versleuteld met een AES-256-GCM sessiesleutel afgeleid van ML-KEM-768 - de relay kan het niet lezen. Wallet-transacties en chain-blocks worden ondertekend met ML-DSA-65 (FIPS 204) en SPHINCS+ (FIPS 205).", fr: "Chiffrement de bout en bout AES-256-GCM via l'API Web Crypto du navigateur. Le relais ne voit que du texte chiffre opaque, jamais le contenu. Voix et video utilisent DTLS-SRTP de WebRTC. L'echange de cles utilise ML-KEM-768 (FIPS 203, post-quantique NIST). La signalisation des appels (SDP/ICE) est chiffree avec une cle de session AES-256-GCM derivee de ML-KEM-768 - le relais ne peut pas la lire. Les transactions du portefeuille et les blocs de la chaine sont signes avec ML-DSA-65 (FIPS 204) et SPHINCS+ (FIPS 205).", es: "Cifrado de extremo a extremo AES-256-GCM via Web Crypto API del navegador. El relay solo ve texto cifrado opaco, nunca el contenido. Voz y video usan DTLS-SRTP de WebRTC. El intercambio de claves usa ML-KEM-768 (FIPS 203, post-cuantico NIST). La senalizacion de llamadas (SDP/ICE) esta cifrada con una clave de sesion AES-256-GCM derivada de ML-KEM-768 - el relay no puede leerla. Las transacciones de billetera y los bloques de cadena se firman con ML-DSA-65 (FIPS 204) y SPHINCS+ (FIPS 205).", ru: "Skvoznoe shifrovanie AES-256-GCM cherez Web Crypto API brauzera. Relay vidit tolko neprozrachnyj shifrtekst, nikogda ne soderzhimoe. Golos i video ispolzuyut DTLS-SRTP iz WebRTC. Obmen klyuchami ispolzuet ML-KEM-768 (FIPS 203, postkvantovyj NIST). Signalizatsiya zvonkov (SDP/ICE) shifruetsya sessionnym klyuchom AES-256-GCM, vyvedennym iz ML-KEM-768 - relay ne mozhet ego prochitat. Tranzaktsii koshelka i bloki tsepi podpisyvayutsya s ML-DSA-65 (FIPS 204) i SPHINCS+ (FIPS 205).", de: "AES-256-GCM Ende-zu-Ende-Verschlusselung uber die Web Crypto API des Browsers. Der Relay sieht nur undurchsichtigen Geheimtext, niemals den Inhalt. Sprache und Video verwenden WebRTC DTLS-SRTP. Schlusselaustausch verwendet ML-KEM-768 (FIPS 203, NIST post-quantum). Anruf-Signalisierung (SDP/ICE) wird mit einem AES-256-GCM Sitzungsschlussel verschlusselt, der von ML-KEM-768 abgeleitet ist - der Relay kann sie nicht lesen. Wallet-Transaktionen und Chain-Blocks werden mit ML-DSA-65 (FIPS 204) und SPHINCS+ (FIPS 205) signiert.", sl: "AES-256-GCM sifriranje od konca do konca prek Web Crypto API. Relay vidi le neprosojen sifrobesedilo, nikoli vsebine. Glas in video uporabljata WebRTC DTLS-SRTP. Izmenjava kljucev uporablja ML-KEM-768 (FIPS 203, NIST postkvantni). Signalizacija klicev (SDP/ICE) je sifrirana z AES-256-GCM seznim kljucem, izpeljanim iz ML-KEM-768 - relay je ne more brati. Transakcije denarnice in bloki verige so podpisani z ML-DSA-65 (FIPS 204) in SPHINCS+ (FIPS 205).", lg: "Enkuuma AES-256-GCM eyitwa ku Web Crypto API. Relay erabira ssente esirikidde yokka, si by'omunda. Voice ne video bikozesa DTLS-SRTP eya WebRTC. Okwawukana kw'obusumuluzo kukozesa ML-KEM-768 (FIPS 203, NIST post-quantum). Signaling y'okukubirwa (SDP/ICE) ekuumiddwa n'ekisumuluzo eky'olukiiko AES-256-GCM ekivudde mu ML-KEM-768 - relay teyinza kukisoma. Wallet transactions ne chain blocks bisaayinwa ne ML-DSA-65 (FIPS 204) ne SPHINCS+ (FIPS 205).", sw: "Usimbaji AES-256-GCM mwanzo hadi mwisho kupitia Web Crypto API. Relay inaona maandishi yaliyosimbwa tu, si yaliyomo. Sauti na video zinatumia DTLS-SRTP ya WebRTC. Kubadilishana funguo kunatumia ML-KEM-768 (FIPS 203, post-quantum ya NIST). Ishara za simu (SDP/ICE) zimesimbwa kwa funguo ya kikao AES-256-GCM iliyotokana na ML-KEM-768 - relay haiwezi kuzisoma. Miamala ya pochi na vitalu vya mlolongo zinasainiwa kwa ML-DSA-65 (FIPS 204) na SPHINCS+ (FIPS 205)." },
  ...
  "mod.deadman": { en: "Safety Check-in", nl: "Safety Check-in", fr: "Commutateur d'Homme Mort", es: "Interruptor de Hombre Muerto", ru: "Mertvaya ruka", de: "Totmannschalter", sl: "Mrtva roka", lg: "Eswiichi y'omufu", sw: "Swichi ya Mtu Aliyekufa" },
...
export default function SpeaqApp() {
  ...
  // Compress image before sending. Default 1280px / quality 0.75 for chat photos (sharp but payload stays well under relay limit).
  // Callers pass smaller explicit values for thumbnails (profile 80px, QC avatar 200px).
  const compressImage = (dataUrl: string, maxW = 1280, quality = 0.75): Promise<string> => {
  ...
  useEffect(() => {
    ...
    fetch(`${RELAY_URL.replace("wss://", "https://")}/api/v1/dms/register`, {
      ...
      body: JSON.stringify({
        ...
        recipientIds,
        encryptedMessage: deadmanConfig.message || "Safety check-in alert - user has not checked in.",
      }),
    }).catch(() => {});
  ...
  if (screen === "onboarding") {
    const slides = [
      { icon: "Q", title: t("onb.slide1.title", lang), sub: t("onb.slide1.sub", lang) },
      { icon: "C", title: t("onb.slide2.title", lang), sub: t("onb.slide2.sub", lang) },
      { icon: "$", title: t("onb.slide3.title", lang), sub: t("onb.slide3.sub", lang) },
      { icon: "G", title: t("onb.slide4.title", lang), sub: t("onb.slide4.sub", lang) },
      { icon: "M", title: t("onb.slide5.title", lang), sub: t("onb.slide5.sub", lang) },
    ];
    ...
    return (
      <div className="h-dvh bg-bg-deep flex flex-col items-center justify-center">
        ...
        <button
          ...
          aria-hidden={pinInput.length < 4}
          tabIndex={pinInput.length < 4 ? -1 : 0}
          className={`mt-6 px-10 py-3 rounded-xl bg-voice-gold text-bg-deep font-body font-semibold text-base min-h-[44px] transition-opacity ${pinInput.length < 4 ? "opacity-0 pointer-events-none" : "opacity-100"}`}
        >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4">
          ...
          <div className="bg-bg-card rounded-xl p-4 border border-[rgba(100,116,139,0.15)]">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-text-muted leading-snug pl-0 -mt-0.5">{t("earning.totalMinedNote", lang)}</p>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4">
          ...
          <div className="bg-bg-card rounded-xl p-4 border border-[rgba(100,116,139,0.15)]">
            <textarea value={vaultNoteInput} onChange={(e) => setVaultNoteInput(e.target.value)} placeholder="Secure note..."
              className="w-full px-3 py-2 rounded-lg border border-[rgba(100,116,139,0.3)] font-body text-sm min-h-[60px] resize-none"
...
The SPEAQ relay server operates on a privacy-first principle:
  ...
  return (
    <div className="h-dvh bg-bg-deep flex flex-col">
      ...
      <header className="flex items-center justify-between px-4 py-3 bg-bg-surface border-b border-[rgba(100,116,139,0.15)] shrink-0">
        ...
        <div className="flex items-center gap-2"><div className={`w-2 h-2 rounded-full ${connected ? "bg-quantum-teal" : "bg-resistance-red"}`} /><span className="text-[10px] font-mono text-text-muted">{connected ? "ONLINE" : "OFFLINE"}</span></div>
      </header>
