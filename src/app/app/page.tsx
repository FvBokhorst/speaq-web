...
const appStrings: Record<string, Record<string, string>> = {
  ...
  "earning.totalMined": { en: "Network Distributed", nl: "Netwerk Uitgegeven", fr: "Distribue Reseau", es: "Distribuido Red", ru: "Raspredeleno v seti", de: "Netzwerk Verteilt", sl: "Omrezje porazdeljeno", lg: "Omukutu gwagabiddwa", sw: "Mtandao uliosambazwa" },
