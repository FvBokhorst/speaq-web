    ...
    return (
      <div className="min-h-dvh bg-bg-deep flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4">
          ...
          {[
            { name: "Chat", desc: "Quantum-encrypted messaging", icon: <IconChat className="w-4 h-4" /> },
            { name: "Call", desc: "WebRTC voice calls", icon: <IconPhone className="w-4 h-4" /> },
            { name: "Pay", desc: "Q-Credits gold-pegged currency", icon: <IconWallet className="w-4 h-4" /> },
            { name: "Mining", desc: "Proof of Contribution rewards", icon: <IconMining className="w-4 h-4" /> },
            { name: "Groups", desc: "Encrypted group conversations", icon: <IconGroup className="w-4 h-4" /> },
            { name: "Ghost Groups", desc: "Anonymous messaging", icon: <IconGhost className="w-4 h-4" /> },
            { name: "Witness Mode", desc: "Tamper-proof evidence", icon: <IconEye className="w-4 h-4" /> },
            { name: "Dead Man's Switch", desc: "Auto-alert system", icon: <IconAlert className="w-4 h-4" /> },
            { name: "Sovereign ID", desc: "Self-sovereign identity (DID)", icon: <IconFingerprint className="w-4 h-4" /> },
            { name: "Lightning", desc: "Bitcoin Lightning integration", icon: <IconZap className="w-4 h-4" /> },
          ].map((mod) => (
          ...
          <div className="bg-bg-card rounded-xl p-4 border border-[rgba(100,116,139,0.15)]">
            ...
            <p className="text-xs text-text-secondary leading-relaxed">AES-256-GCM encryption via Web Crypto API. Keys derived locally from SPEAQ IDs. Zero-knowledge architecture -- no one can read your messages, not even SPEAQ.</p>
          </div>
          <div className="bg-bg-card rounded-xl p-4 border border-[rgba(100,116,139,0.15)]">
            <p className="text-xs font-mono text-quantum-teal uppercase tracking-wider mb-2">{t("info.tokenomics", lang)}</p>
            <div className="space-y-1 text-xs text-text-secondary">
              <p>Max Supply: 21,000,000 QC (fixed)</p>
              <p>1 QC = 0.01 gram gold (pegged)</p>
              <p>1 QC = 100,000,000 Sparks</p>
              <p>Halving: every 2,100,000 QC mined</p>
              <p>Mining yield: ~5-8% annual</p>
            </div>
          </div>
        </div>
      </div>
