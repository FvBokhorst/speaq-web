...
const appStrings: Record<string, Record<string, string>> = {
  ...
  "adv.ghost": { en: "Ghost Groups", ru: "Prizrachnye gruppy", nl: "Ghost Groepen", fr: "Groupes Fantomes", es: "Grupos Fantasma", de: "Geister Gruppen", sl: "Nevidne skupine", lg: "Ebibinja ebitabika", sw: "Vikundi vya roho" },
  "adv.ghostDesc": { en: "Anonymous group chats with hidden identities", ru: "Anonimnye gruppovye chaty so skrytymi lichnostyami", nl: "Anonieme groepsgesprekken met verborgen identiteiten", fr: "Discussions de groupe anonymes avec identites cachees", es: "Chats grupales anonimos con identidades ocultas", de: "Anonyme Gruppengesprache mit versteckten Identitaten", sl: "Anonimni skupinski klepeti s skritimi identitetami", lg: "Emboozi z'ekibinja ezitamanyiddwa n'abantu abakwekeddwa", sw: "Mazungumzo ya vikundi yasiyojulikana na utambulisho uliofichwa" },
  ...
  "adv.deadman": { en: "Dead Man's Switch", ru: "Mertvaya ruka", nl: "Dead Man's Switch", fr: "Commutateur d'Homme Mort", es: "Interruptor de Hombre Muerto", de: "Totmannschalter", sl: "Mrtva roka", lg: "Eswiichi y'omufu", sw: "Swichi ya Mtu Aliyekufa" },
  ...
  "ui.ghostWitness": { en: "Vault / Ghost / Witness / Dead Man", nl: "Kluis / Ghost / Getuige / Dead Man", fr: "Coffre / Fantome / Temoin / Homme Mort", es: "Boveda / Fantasma / Testigo / Hombre Muerto", ru: "Khranilishche / Prizrak / Svidetel / Mertvaya ruka", de: "Tresor / Geist / Zeuge / Totmannschalter", sl: "Trezor / Duh / Prica / Mrtva roka", lg: "Ekisanirizo / Ekitabika / Omujulizi / Eswiichi", sw: "Kabati / Mzimu / Shahidi / Swichi" },
  ...
  return (
    <div className="h-dvh bg-bg-deep flex flex-col">
      ...
      <header className="flex items-center justify-between px-4 py-3 bg-bg-surface border-b border-[rgba(100,116,139,0.15)] shrink-0">
        ...
        <div className="flex items-center gap-2"><span className="text-[8px] font-mono text-text-muted/40">v105</span><div className={`w-2 h-2 rounded-full ${connected ? "bg-quantum-teal" : "bg-resistance-red"}`} /><span className="text-[10px] font-mono text-text-muted">{connected ? "ONLINE" : "OFFLINE"}</span></div>
      </header>
